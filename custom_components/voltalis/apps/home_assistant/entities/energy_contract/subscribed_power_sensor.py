...
class VoltalisEnergyContractSubscribedPowerSensor(VoltalisEnergyContractEntity, SensorEntity):  # pyright: ignore[reportIncompatibleVariableOverride]
    """Sensor entity for Voltalis energy contract subscribed power."""
