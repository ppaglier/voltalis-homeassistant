...
class VoltalisEnergyContractKwhBaseCostSensor(VoltalisEnergyContractEntity, SensorEntity):
    """Sensor entity for Voltalis energy contract kWh base cost."""

    _attr_device_class = SensorDeviceClass.MONETARY
    _attr_native_unit_of_measurement = CURRENCY_EURO
    _attr_translation_key = "energy_contract_kwh_base_cost"
    _attr_icon = "mdi:currency-eur"
    _unique_id_suffix = "energy_contract_kwh_base_cost"

    def __init__(self, entry: VoltalisConfigEntry, energy_contract: VoltalisEnergyContract) -> None:
        """Initialize the energy contract kWh base cost sensor."""
