...
#     entities = [VoltalisWaterHeater(d, coordinator) for d in devices if d.is_water_heater()]
#     add_entities(entities)


# class VoltalisWaterHeater(WaterHeaterEntity):
#     """Class that handle voltalis water heater entity"""
...
#         self._attr_unique_id = f"{device.id}_water_heater"
...
#         # Convert HA preset -> Voltalis mode
